...
<html>
	...
	<body class="home-welcome-text" style="background-image: url(image/republic-of-gamers-8-bit-3n-1400x1050.jpg);">
		...
		<div class="holecontainer" style="float: right; margin-right: 36%; padding-top: 209px;">
			<div class="container">
				<div>
					<div>
						<div class="signupform_content">
							<?php
							 	if (isset($activacc)){
							 		echo '<h2 style="color: white;">Activation Form</h2>';
							 	}else {
							 		echo '<h2 style="color: white;">Login Form</h2>';
							 	}
							?>
							</div>
							...
							<div>
								<form action="" method="POST" class="registration">
									<div class="signup_form">
											...
											if (isset($activacc)) {
												...
												echo '
													<div class="signup_error_msg">
														<div class="maincontent_text" style="text-align: center; font-size: 18px; color: lightblue;">
										...
										<div>
											<input style="color: white; background-color: green;"name="login" class="uisignupbutton signupbutton" type="submit" value="Log In">
										</div>
										';
											}
										  ?>
