...
<html>
	...
	<body class="home-welcome-text" style="background-image: url(image/republic-of-gamers-8-bit-3n-1400x1050.jpg); height: 400;">
		...
		<?php 
			...
			>										</div>
													...
													<div>
														<input style="color: white; background-color: green;" name="signup" class="uisignupbutton signupbutton" type="submit" value="Sign Me Up!">
													</div>
