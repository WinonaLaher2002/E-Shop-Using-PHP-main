...
<body>
	...
	<div style="padding: 30px 120px; font-size: 25px; margin: 0 auto; display: table; width: 98%;">
		<div>
		<?php 
                           $query=("SELECT * FROM products WHERE available >='1' AND item ='computers'  ORDER BY id DESC LIMIT 10") or die(mysql_error());
							...
							<ul style="float: left;">
								<li style="float: left; padding: 0px 25px 25px 25px;">
									<div class="home-prodlist-img"><a href="view_product.php?pid='.$id.'">
										<img src="../image/products/computers/'.$picture.'" class="home-prodlist-imgi">
										</a>
